...
{
  "$end", "error", "$undefined", "EOI", "DATA", "$accept", "solv",
  "exprn", YY_NULLPTR
};
#endif
...
#line 26 "parser.y" /* yacc.c:1646  */
    {make_processor();exit(0);}
#line 1214 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 28 "parser.y" /* yacc.c:1646  */
    {instruction* instr = make_instruction((yyvsp[0].str)); add_instruction(instr);}
#line 1220 "parser.tab.c" /* yacc.c:1646  */
    break;
